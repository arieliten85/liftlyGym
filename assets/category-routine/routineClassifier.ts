...
export function classifyRoutine(
    ...
    if (hasAll(m, "pecho", "triceps"))
      return build(
        ...
        [
          ...
          "Complementá con Espalda+Bíceps otro día — es el split más balanceado del tren superior.",
        ],
        lvl,
        m,
  ...
  if (n === 3) {
      ...
      return build(
        ...
        [
          ...
          lvl === "principiante"
            ...
            : "Empuje A (foco pecho): Press plano pesado. Empuje B (foco hombros): Press militar pesado. Alternando semanas.",
          "El complemento natural es un día de tirón (Espalda+Bíceps) — sin él el programa está incompleto.",
        ],
        lvl,
        m,
        "Split más eficiente: Empuje / Tirón / Piernas — o — Empuje / Tirón / Descanso (repetir)",
      );
    ...
    if (hasAll(m, "espalda", "biceps", "hombro"))
      return build(
        ...
        [
          ...
          "Complementá con día de empuje para el balance de torso.",
        ],
        lvl,
        m,
      );
    ...
    if (hasLegs(m) && hasUpper(m)) {
      ...
      return build(
        ...
        lvl,
        m,
        "Estructura posible: Piernas+Torso / Torso / Piernas / Torso",
      );
    }
  ...
  if (n === 4) {
    if (hasPush(m) && hasPull(m) && !hasLegs(m))
      return build(
        "push_pull",
        "Torso — Empuje + Tirón",
        "Torso completo. Podés hacer todo en una sesión (mayor duración) o dividido en días Empuje/Tirón para mayor calidad.",
        [55, 75],
        [3, 5],
        ["Empuje", "Tirón"],
        [
          "Como sesión única: superseries antagonistas para eficiencia máxima.",
          "Como split Empuje/Tirón: 2 días empuje + 2 días tirón = 4 días, alta frecuencia por grupo.",
          "Con 3 días: Empuje / Tirón / Torso completo alternando.",
          lvl === "principiante"
            ? "Empezá con 3 días: Empuje / Tirón / Torso completo. Mejor que intentar los 4 días desde el inicio."
            : "4 días Empuje/Tirón/Empuje/Tirón es el estándar de referencia para este bloque.",
          "Sin piernas el programa está incompleto — el tren inferior no puede ignorarse.",
        ],
        lvl,
        m,
        lvl === "principiante"
          ? "3 días: Empuje / Tirón / Torso completo"
          : "4 días: Empuje / Tirón / Empuje / Tirón",
      );
    ...
    if (hasLegs(m) && hasPush(m) && hasPull(m))
      return build(
        ...
        ["Torso", "Piernas"],
        [
          "Torso A (énfasis empuje): Press plano pesado, Press inclinado, Press militar, Tríceps.",
          "Torso B (énfasis tirón): Dominadas/Jalón, Remo, Curl bíceps, Face pull.",
          "Piernas A y B pueden ser iguales o dividir quad-dominante / femoral-dominante.",
          lvl === "principiante"
            ? "Con 3 días: Torso / Piernas / Torso alternando semana a semana con Piernas / Torso / Piernas."
            : "4 días: Torso A / Piernas / Torso B / Piernas — cada músculo trabaja 2 veces por semana.",
          "Es el split más estudiado: óptimo en frecuencia, volumen y recuperación.",
        ],
        lvl,
        m,
        "4 días: Torso(empuje) / Piernas / Torso(tirón) / Piernas",
      );
    ...
    if (hasPush(m) && hasLegs(m) && !hasPull(m))
      return build(
        "piernas_plus",
        "Empuje + Piernas",
        "Tren anterior completo + tren inferior. Falta el bloque de tirón para un programa balanceado.",
        [55, 70],
        [3, 4],
        ["Empuje", "Piernas"],
        [
          "Distribuí en días: Empuje / Piernas / Empuje / Piernas.",
          "Sin espalda y bíceps — importante añadir 1-2 días de tirón a la semana.",
          "Esta selección cubre bien el tren anterior — completá con tirón para balance total.",
          lvl === "principiante"
            ? "3 días: Empuje / Piernas / Empuje alternando."
            : "Agregá 1-2 días de tirón para un programa completo.",
        ],
        lvl,
        m,
      );
    ...
    if (hasPull(m) && hasLegs(m) && !hasPush(m))
      return build(
        "piernas_plus",
        "Tirón + Piernas",
        "Tren posterior completo + tren inferior. Falta el bloque de empuje para el programa completo.",
        [55, 70],
        [3, 4],
        ["Tirón", "Piernas"],
        [
          "Distribuí en días: Tirón / Piernas / Tirón / Piernas.",
          "Sin pecho, hombros y tríceps — el balance de torso está incompleto.",
          "Agregá días de empuje para completar el programa.",
          lvl === "principiante"
            ? "3 días: Tirón / Piernas / Tirón."
            : "4-5 días: Tirón / Piernas / Empuje / Tirón / Piernas.",
        ],
        lvl,
        m,
      );
  ...
  if (n === 5) {
    if (hasPush(m) && hasPull(m) && hasLegs(m))
      return build(
        ...
        ["Empuje", "Tirón", "Piernas"],
        [
          "Empuje: pecho + hombros + tríceps en un día.",
          "Tirón: espalda + bíceps en un día.",
          "Piernas: piernas completo (quad + femoral + pantorrillas).",
          lvl === "principiante"
            ? "ETP 3 días/semana: un ciclo completo. Ideal para el primer año."
            : lvl === "intermedio"
              ? "ETP 5-6 días: dos ciclos por semana — cada músculo recibe 2 estímulos semanales."
              : "ETP 6 días x2 ciclos: máxima frecuencia. Requiere excelente recuperación y nutrición.",
          "Con 6 días agregá un día de descanso activo (caminar, movilidad) para no acumular fatiga.",
        ],
        lvl,
        m,
        lvl === "principiante"
          ? "3 días: Empuje / Tirón / Piernas (repetir la semana siguiente)"
          : "6 días: Empuje / Tirón / Piernas / Empuje / Tirón / Piernas",
      );
    ...
    if (!hasLegs(m))
      return build(
        ...
        ["Torso"],
        [
          "Con 4-5 días: Empuje / Tirón / Torso completo / Brazos.",
  ...
  if (n === 6)
    return build(
      "fullbody",
      "Cuerpo Completo",
      "Todos los grupos musculares. Ideal como cuerpo completo (todos en cada sesión con 1-2 series por grupo) o como Empuje/Tirón/Piernas x2 (6 días divididos).",
      [55, 80],
      [3, 6],
      ["Cuerpo Completo"],
      [
        "Cuerpo completo 3x: todos los grupos en cada sesión, 2-3 series por grupo. Frecuencia 3x por semana.",
        "ETP 6x: Empuje/Tirón/Piernas repetido dos veces. Frecuencia 2x por semana por músculo.",
        lvl === "principiante"
          ? "Cuerpo completo 3 días es la MEJOR opción para principiantes. Máxima frecuencia de movimiento."
          : lvl === "intermedio"
            ? "ETP 5-6 días — la frecuencia doble por músculo es clave para continuar progresando."
            : "ETP 6 días o Torso/Piernas 4 días son los estándares para atletas avanzados.",
        "Priorizá sueño (7-9hs) y nutrición — sin recuperación el volumen alto es contraproducente.",
        "En cuerpo completo los ejercicios DEBEN ser compuestos. No tiene sentido hacer curl en un programa de cuerpo completo.",
      ],
      lvl,
      m,
      lvl === "principiante"
        ? "Cuerpo completo: Lunes / Miércoles / Viernes"
        : lvl === "intermedio"
          ? "ETP 5 días: Empuje / Tirón / Piernas / Empuje / Tirón"
          : "ETP 6 días: Empuje / Tirón / Piernas / Empuje / Tirón / Piernas",
    );
  ...
  return {
    routineType: "custom",
    routineLabel: "Rutina Personalizada",
    routineDescription:
