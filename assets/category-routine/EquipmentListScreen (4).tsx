...
// Cupo total de equipos por nivel — el back usa estos ids para armar la rutina.
...
function resolveAllEquipmentIds(
  ...
  const cap = TOTAL_EQUIPMENT_CAP[experience ?? "principiante"] ?? 4;

  // Distribuir: base equitativo para todos + un slot extra a los grupos grandes.
  ...
  // Tomar los primeros N ids de cada grupo (ordenados de más a menos compuesto).
